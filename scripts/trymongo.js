...
async function testWithAsync() {
    let db;
    const connection = await MongoClient.connect('mongodb://localhost/playground');
    db = connection;
    const insertResult = db.collection('employees').insertOne({id: 1, name: 'D. Async'});
